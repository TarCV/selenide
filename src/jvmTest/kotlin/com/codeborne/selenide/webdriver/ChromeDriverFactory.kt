...
open class ChromeDriverFactory : AbstractDriverFactory() {
    ...
    companion object {
        private val log = LoggerFactory.getLogger(ChromeDriverFactory::class)

        // Regexp from https://stackoverflow.com/a/15739087/1110503 to handle commas in values
        private val REGEX_COMMAS_IN_VALUES = kotlin.text.Regex(",(?=([^\"]*\"[^\"]*\")*[^\"]*$)")
        private val REGEX_REMOVE_QUOTES = kotlin.text.Regex("\"", kotlin.text.Regex.LITERAL)
    }
}
