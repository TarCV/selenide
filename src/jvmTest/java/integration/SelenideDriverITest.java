...
final class SelenideDriverITest extends ITest {
  ...
  void canCreatePageObjects() {
    Page1 page1 = browser1.open("/page_with_images.html" + browser1.config().browser(), Page1.class);
    Page2 page2 = browser2.open("/page_with_selects_without_jquery.html" + browser2.config().browser(), Page2.class);
