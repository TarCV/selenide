...
interface SelenideElement : WebElement, WrapsDriver, WrapsElement, Locatable, TakesScreenshot, HasIdentity {
  ...
  /**
     ...
     */
    @CanIgnoreReturnValue
    fun uploadFromClasspath(vararg fileName: String): File
     ...
     */
    @CanIgnoreReturnValue
    fun uploadFile(vararg file: File): File
    ...
    @CheckReturnValue
    @Throws(FileNotFoundException::class)
    fun download(timeout: Long): File
    ...
    @CheckReturnValue
    @Throws(FileNotFoundException::class)
    fun download(fileFilter: FileFilter): File
    ...
    @CheckReturnValue
    @Throws(FileNotFoundException::class)
    fun download(timeout: Long, fileFilter: FileFilter): File
