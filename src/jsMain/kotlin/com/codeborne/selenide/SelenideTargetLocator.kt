...
class SelenideTargetLocator(private val driver: Driver) : TargetLocator {
    ...
    override suspend fun frame(index: Int): WebDriver {
        return try {
    ...
    @kotlin.time.ExperimentalTime
    override suspend fun frame(nameOrId: String): WebDriver {
        return try {
    ...
    @kotlin.time.ExperimentalTime
    override suspend fun frame(frameElement: WebElement): WebDriver {
        return try {
    ...
    override suspend fun parentFrame(): WebDriver {
        return delegate.parentFrame()
    }

    override suspend fun defaultContent(): WebDriver {
        return delegate.defaultContent()
    }

    override suspend fun activeElement(): WebElement {
        return delegate.activeElement()
    }

    @kotlin.time.ExperimentalTime
    override suspend fun alert(): Alert {
        return try {
     ...
     */
    @kotlin.time.ExperimentalTime
    suspend fun innerFrame(vararg frames: String): WebDriver {
     ...
     */
    @kotlin.time.ExperimentalTime
    suspend fun window(index: Int): WebDriver? {
        return try {
     ...
     */
    @kotlin.time.ExperimentalTime
    suspend fun window(index: Int, duration: Duration): WebDriver {
        return try {
     ...
     */
    @kotlin.time.ExperimentalTime
    override suspend fun window(nameOrHandleOrTitle: String): WebDriver {
        return try {
     ...
     */
    @kotlin.time.ExperimentalTime
    suspend fun window(nameOrHandleOrTitle: String, duration: Duration): WebDriver {
        return try {
