...
abstract class Condition constructor(
     ...
     */
    abstract suspend fun apply(driver: Driver, element: WebElement): Boolean
     ...
     */
    open suspend fun actualValue(driver: Driver, element: WebElement): String? {
        return null
    }
    ...
    companion object {
         ...
         */
            fun match(description: String, predicate: (WebElement) -> Boolean): Condition {
