...
class WebDriverWrapper private constructor(
    config: Config, webDriver: org.openqa.selenium.WebDriver,
    ...
    override val webDriver: org.openqa.selenium.WebDriver
    ...
    override val getAndCheckWebDriver: org.openqa.selenium.WebDriver
        get() {
