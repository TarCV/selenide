 ...
 */
interface SelenideElement : org.openqa.selenium.WebElement, org.openqa.selenium.WrapsDriver,
...
//TODO:    fun download(options: DownloadOptions): Path
     ...
     */
    fun toWebElement(): org.openqa.selenium.WebElement
     ...
     */
    override fun getWrappedElement(): org.openqa.selenium.WebElement
     ...
     * @see com.codeborne.selenide.commands.DragAndDropTo
     */
    fun dragAndDropTo(target: org.openqa.selenium.WebElement): SelenideElement
