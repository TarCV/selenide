...
class ElementsCollection(private val collection: CollectionSource) {
    constructor(driver: Driver, elements: Collection<org.openqa.selenium.WebElement>) : this(
    ...
    protected suspend fun waitUntil(condition: CollectionCondition, timeout: Duration) {
        ...
        var actualElements: List<org.openqa.selenium.WebElement>? = null
    ...
    private suspend fun getElements(): List<org.openqa.selenium.WebElement> = collection.getElements()
    ...
    companion object {
         ...
         * @return String
         */
    suspend fun elementsToString(driver: Driver, elements: Collection<org.openqa.selenium.WebElement>?): String {
            if (elements == null) {
